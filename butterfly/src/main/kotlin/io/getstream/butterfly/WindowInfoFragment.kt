...
/**
 * WindowInfoFragment tracks window configurations and update the [WindowLayoutInfo] by invoking
 * [onWindowLayoutInfoUpdated]. Also, provides a default property [windowSize] which includes
 * definition of the screen size.
 */
public abstract class WindowInfoFragment : Fragment() {

    /** A definition of the screen size, this property will be initialized lazily. */
    protected val windowSize: WindowSize by lazy(LazyThreadSafetyMode.NONE) {
        requireActivity().getWindowSize()
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().collectWindowLayoutInfo(::onWindowLayoutInfoUpdated)
    }
