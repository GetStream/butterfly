...
/**
 * WindowInfoAppcompatActivity tracks window configurations and update the [WindowLayoutInfo] by invoking
 * [onWindowLayoutInfoUpdated]. Also, provides a default property [windowSize] which includes
 * definition of the screen size.
 */
public abstract class WindowInfoAppcompatActivity : AppCompatActivity() {
